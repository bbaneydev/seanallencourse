...
var pet = Pets.hamster

switch pet {
case .dog, .cat, .frog:
    print("Would be good for children")
default:
    print("May be hard for children")
}
