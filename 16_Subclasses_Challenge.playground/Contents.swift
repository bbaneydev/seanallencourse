...
let myPickup = Pickup(make: "Ford", model: "F150", modelYear: 2020, color: "blue", maxSpeed: 120, value: 45000, extendedCab: false, is4WD: true, isHeavyDuty: false)



// Print out a message whether the truck has 4WD.
print("Does my truck have 4WD: \(myPickup.is4WD ? "Yes, it does!" : "No, it does not!")")
...
// Answer: make values optional and make a separate initializer to initialize an empty truck class
